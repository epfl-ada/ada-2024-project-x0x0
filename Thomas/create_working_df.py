...
## Load all the data
small_path = 'baseData/minimizedData/'

BAs_beers = pd.read_csv(small_path + 'BA_beers_small.csv', dtype=dtype_BAs_beers)
BAs_breweries = pd.read_csv(small_path + 'BA_breweries_small.csv', dtype=dtype_BAs_breweries)
BAs_ratings = pd.read_csv(small_path + 'BA_ratings_small.csv', dtype=dtype_BAs_ratings)
BAs_users = pd.read_csv(small_path + 'BA_users_small.csv', dtype=dtype_BAs_users)

RBs_beers = pd.read_csv(small_path + 'RB_beers_small.csv', dtype=dtype_RBs_beers)
RBs_breweries = pd.read_csv(small_path + 'RB_breweries_small.csv', dtype=dtype_RBs_breweries)
RBs_ratings = pd.read_csv(small_path + 'RB_ratings_small.csv', dtype=dtype_RBs_ratings)
RBs_users = pd.read_csv(small_path + 'RB_users_small.csv', dtype=dtype_RBs_users)
